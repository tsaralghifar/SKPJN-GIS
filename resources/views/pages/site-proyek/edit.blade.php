	...
	<div class="row">
		...
		<div class="col-md-4">
			<div class="card">
				...
				<div class="card-body">
					<form action="{{ route('site.update', $proyek->id) }}" method="POST">
						@csrf
						@method('PUT')
						{{-- @if ($idEdit)
						...
						<div class="form-group">
							...
							<input type="text"
								id="koordinat"
								name="koordinat"
								value="{{ old('koordinat') ? old('koordinat') : $proyek->koordinat }}"
						...
						<div class="form-group">
							...
							<input type="text"
								name="nama_proyek"
								value="{{ old('nama_proyek') ? old('nama_proyek') : $proyek->nama_proyek }}"
...
<script>
    ...
    // get coordinat
    var curLocation = [{{$proyek->koordinat}}];
