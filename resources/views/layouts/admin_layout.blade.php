...
<html lang="en">
    ...
    <body>
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <a class="navbar-brand" href="index.html">SKPJN</a>
                        ...
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts2" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a class="nav-link" href="{{route('anggaran-masuk')}}">Anggaran Masuk</a>
                                    <a class="nav-link" href="{{route('anggaran-keluar')}}">Anggaran Keluar</a>
                                </nav>
                            </div>
